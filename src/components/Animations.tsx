...
export const staggerText = (node1: any, node2: any, node3: any, node4: any) => {
...
// Hover on the link
export const handleHover = (e: any) => {
  gsap.to(e.target, {
    duration: 0.3,
    y: 3,
    skewX: 4,
...
// Hover off the link
export const handleHoverExit = (e: any) => {
  gsap.to(e.target, {
    duration: 0.3,
    y: -3,
    skewX: 0,
...
export const handleCity = (city: any, target: any) => {
  gsap.to(target, {
    duration: 0,
...
export const handleCityReturn = (target: any) => {
  gsap.to(target, {
    duration: 0,
    skewY: 0
  });
